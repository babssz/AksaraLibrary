    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center mb-6">
                ...
                <div>
                    <h1 class="text-xl font-semibold text-primary">Edit User: {{ $user->name }}</h1>
                    <p class="text-gray-600">Perbarui informasi akun user</p>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3" 
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary transition duration-200">{{ old('address', $user->address) }}</textarea>
                    </div>
