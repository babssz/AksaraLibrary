    ...
    <div class="container mx-auto px-4 py-3">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('notifications.index') }}" class="relative text-accent hover:text-white transition">
    ...
    <nav class="bg-secondary text-white shadow-md">
        <div class="container mx-auto px-4">
            <div class="flex space-x-8 py-3">
                ...
                <a href="{{ route('mahasiswa.dashboard') }}" class="hover:text-accent transition flex items-center space-x-1">
