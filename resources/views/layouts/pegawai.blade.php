...
<head>
    ...
    <title>Pegawai - @yield('title', 'Dashboard') - Perpustakaan Universitas Aksara</title>
        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-accent text-sm">PEGAWAI PANEL</p>
                </div>
            </div>
            
            <div class="flex items-center space-x-4">
                <!-- User Dropdown untuk Pegawai -->
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center space-x-2 text-accent hover:text-white transition">
                        ...
                        <span>Pegawai: {{ auth()->user()->name }}</span>
                    ...
                    <div x-show="open" @click.away="open = false" 
                        ...
                        <div class="px-4 py-2 text-sm text-gray-700 border-b">
                            ...
                            @if(auth()->user()->nip)
                            <div class="text-gray-500 text-xs">NIP: {{ auth()->user()->nip }}</div>
                            @endif
                            <div class="text-gray-500 text-xs">Role: Pegawai</div>
                        </div>
    ...
    <nav class="bg-secondary text-white shadow-md">
        <div class="container mx-auto px-4">
            <div class="flex space-x-8 py-3">
                ...
                <a href="{{ route('pegawai.dashboard') }}" class="hover:text-accent transition flex items-center space-x-1">
    ...
    <footer class="bg-primary text-white mt-12">
        <div class="container mx-auto px-4 py-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    <h4 class="font-bold mb-4">Pegawai Panel</h4>
                    <ul class="space-y-2 text-accent">
                        <li><a href="{{ route('pegawai.dashboard') }}" class="hover:text-white transition">Dashboard</a></li>
                ...
                <div>
                    ...
                    <p class="text-accent">Pegawai Helpdesk: pegawai@univ-aksara.ac.id</p>
                    <p class="text-accent">Emergency: (021) 123-4567 ext. 123</p>
                </div>
            </div>
            <div class="border-t border-accent mt-8 pt-6 text-center text-accent">
                <p>&copy; 2024 Perpustakaan Universitas Aksara - Pegawai Panel</p>
            </div>
        </div>
    </footer>
</body>
