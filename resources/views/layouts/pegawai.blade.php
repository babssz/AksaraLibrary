...
<header class="bg-primary text-white shadow-lg sticky top-0 z-50">
    ...
    <div class="container mx-auto px-4">
        <div class="flex space-x-8 py-3">
            ...
            <a href="{{ route('pegawai.dashboard') }}" class="hover:text-yellow-400 transition flex items-center space-x-2 font-semibold {{ request()->is('pegawai*') ? 'text-yellow-400 border-b-2 border-yellow-400' : 'text-white' }}">
